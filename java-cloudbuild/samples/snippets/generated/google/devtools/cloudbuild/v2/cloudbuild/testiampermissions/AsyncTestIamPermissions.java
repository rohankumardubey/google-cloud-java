...
// [START cloudbuild_v2_generated_CloudBuild_TestIamPermissions_async]
  ...
  public static void asyncTestIamPermissions() throws Exception {
    ...
    try (CloudBuildClient cloudBuildClient = CloudBuildClient.create()) {
      ...
      ApiFuture<TestIamPermissionsResponse> future =
          cloudBuildClient.testIamPermissionsCallable().futureCall(request);
      // Do something.
      TestIamPermissionsResponse response = future.get();
    }
  }
}
// [END cloudbuild_v2_generated_CloudBuild_TestIamPermissions_async]
